...
if ([string]::IsNullOrWhiteSpace($OutputDirectory)) {
    $OutputDirectory = Join-Path $repoRoot (".tmp/neoforge-universal-1.21-" + (Get-Date -Format 'yyyyMMdd-HHmmss'))
...
$variants = @(
    ...
    @{ Minecraft = '1.21.4'; NeoForge = '21.4.157' },
    @{ Minecraft = '1.21.8'; NeoForge = '21.8.54' },
    @{ Minecraft = '1.21.11'; NeoForge = '21.11.44' }
)
...
Write-Host "NeoForge 1.21.x variant jars: $variantDirectory"
